...
! *********************************************************************** 
      ...
      integer function extras_binary_check_model(binary_id)
         ...
         use chem_def, only : icno, ipp, category_name
         ...
         if (b% s2% star_mass_h1 > 1d-8) then
               b% s2% L_by_category(ipp)  = 0d0
               b% s2% L_by_category(icno)  = 0d0
               write(*, *) 'No Luminosity with hydrogen mass',b% s2% star_mass_h1
               write(*, *) 'L_by_category(icno)',b% s2% L_by_category(icno)
               write(*, *) 'L_by_category(ipp)',b% s2% L_by_category(ipp)
         end if
